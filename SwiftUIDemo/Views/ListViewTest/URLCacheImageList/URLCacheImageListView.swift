...
struct URLCacheImageListView: View {
    let images = [
    ...
    var body: some View {
        List {
            ForEach(images, id: \.self) { url in
                URLCacheImageListRowView(urlString: url.absoluteString)
            }
        }
    }
}

struct URLCacheImageListView_Previews: PreviewProvider {
    static var previews: some View {
        URLCacheImageListView()
    }
}
